...
ESP.Text = "ESP Gui"
ESP.TextColor3 = Color3.fromRGB(255, 0, 4)
ESP.TextSize = 25.000
...
local function BTMHCYX_fake_script() -- baseplateDestroy.Script 
...
coroutine.wrap(BTMHCYX_fake_script)()
local function OWIMY_fake_script() -- InfiniteYield.Script 
...
coroutine.wrap(OWIMY_fake_script)()
local function ESHH_fake_script() -- FlyGUI.Script 
...
coroutine.wrap(ESHH_fake_script)()
local function JUSS_fake_script() -- GiveAimbotGUI.Script 
...
coroutine.wrap(JUSS_fake_script)()
local function EVWWC_fake_script() -- PrizzGUI.Script 
...
coroutine.wrap(EVWWC_fake_script)()
local function VXJS_fake_script() -- ESP.Script 
	local script = Instance.new('Script', ESP)

	function Click(mouse)
	
	   loadstring(game:HttpGet("https://raw.githubusercontent.com/Robloxhacksmaker/aimbot/refs/heads/main/Vanguard.lua"))();
	end
	
	
	script.Parent.MouseButton1Down:connect(Click)
end
coroutine.wrap(VXJS_fake_script)()
local function GFBBSC_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(GFBBSC_fake_script)()
local function YBXX_fake_script() -- UI_2.LocalScript 
...
coroutine.wrap(YBXX_fake_script)()
