...
local function XLVIF_fake_script() -- baseplateDestroy.Script 
...
coroutine.wrap(XLVIF_fake_script)()
local function VOQT_fake_script() -- InfiniteYield.Script 
...
coroutine.wrap(VOQT_fake_script)()
local function PLASY_fake_script() -- FlyGUI.Script 
...
coroutine.wrap(PLASY_fake_script)()
local function MEKVD_fake_script() -- GiveAimbotGUI.Script 
...
coroutine.wrap(MEKVD_fake_script)()
local function JYMVP_fake_script() -- PrizzGUI.Script 
...
coroutine.wrap(JYMVP_fake_script)()
local function TMBBDC_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(TMBBDC_fake_script)()
local function EQLBAR_fake_script() -- UI_2.LocalScript 
...
coroutine.wrap(EQLBAR_fake_script)()
