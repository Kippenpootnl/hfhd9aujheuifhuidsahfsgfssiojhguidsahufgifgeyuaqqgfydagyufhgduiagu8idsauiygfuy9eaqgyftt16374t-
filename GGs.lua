...
local SolaraHub = Instance.new("TextButton")
...
SolaraHub.Name = "Solara Hub"
SolaraHub.Parent = Container
SolaraHub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
SolaraHub.BackgroundTransparency = 1.000
SolaraHub.BorderColor3 = Color3.fromRGB(27, 42, 53)
SolaraHub.Size = UDim2.new(0, 200, 0, 50)
SolaraHub.Font = Enum.Font.SourceSans
SolaraHub.Text = "Solara hub"
SolaraHub.TextColor3 = Color3.fromRGB(255, 0, 4)
SolaraHub.TextSize = 25.000
SolaraHub.TextWrapped = true
SolaraHub.TextXAlignment = Enum.TextXAlignment.Left
...
local function PVSKB_fake_script() -- FlyGUI.Script 
...
coroutine.wrap(PVSKB_fake_script)()
local function SMJFHVU_fake_script() -- GiveAimbotGUI.Script 
...
coroutine.wrap(SMJFHVU_fake_script)()
local function PBQGZL_fake_script() -- PrizzGUI.Script 
...
coroutine.wrap(PBQGZL_fake_script)()
local function RFHHTX_fake_script() -- C00lkidGUI.Script 
...
coroutine.wrap(RFHHTX_fake_script)()
local function BJAG_fake_script() -- SolaraHub.Script 
	local script = Instance.new('Script', SolaraHub)
...
coroutine.wrap(BJAG_fake_script)()
local function MKLHWD_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(MKLHWD_fake_script)()
local function CPXK_fake_script() -- UI_2.LocalScript 
...
coroutine.wrap(CPXK_fake_script)()
